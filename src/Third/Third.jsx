...
function Third() {
    ...
    const getItems = async () => {
        try{
            const url = 'https://dummyjson.com/products?skip=30&&limit=10';
    ...
    <div>
      ...
      <Dialog
        ...
        <DialogContent>
          ...
          <TextField sx={{width:'200px',margin:'20px',display:'block'}} name='name' value={title}   id="outlined-basic" label="Title" variant="outlined" />
          <TextField sx={{width:'200px',margin:'20px',display:'block'}} name='name' value={brand}   id="outlined-basic" label="Brand" variant="outlined" />
          <TextField sx={{width:'200px',margin:'20px',display:'block'}} name='name' value={price}   id="outlined-basic" label="Price" variant="outlined" />
          </DialogContentText>
        </DialogContent>
        <DialogActions>
